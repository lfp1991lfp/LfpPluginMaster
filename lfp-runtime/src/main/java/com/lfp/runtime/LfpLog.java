...
public class LfpLog {
    ...
    @Pointcut("within(@com.lfp.annotations.DebugLog *)")
...
//	}
    ...
    @Pointcut("execution(@com.lfp.annotations.DebugLog * *(..)) || methodInsideAnnotatedType()")
    public void method() {
    }

    @Pointcut("execution(@com.lfp.annotations.DebugLog *.new(..)) || constructorInsideAnnotatedType()")
